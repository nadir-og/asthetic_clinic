          ...
          {bundles.map((bundle, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`relative bg-white p-6 rounded-[2rem] shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-400 flex flex-col justify-between ${
                  bundle.bestValue
              ...
              >
                ...
                {/* CTA (Pill CTA with hover inversion) */}
                <a
                  href={waBundleLink(bundle.name, bundle.price)}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-zinc-950 text-white font-medium px-6 py-3.5 rounded-full border border-zinc-950 hover:bg-white hover:text-zinc-950 transition-colors duration-300 shadow-sm text-xs uppercase tracking-widest flex items-center justify-center gap-2 w-full mt-6"
                >
